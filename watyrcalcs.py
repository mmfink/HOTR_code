...
Created on Oct 24, 2017 Last updated 07/22/2019 - Built on Python 2.7 but works in 3.7
...
def clean_name(inmodel, inseason, invar):
    """ Create a clean naming prefix for output files
        inmodel = string; the name of the climate model, or equivalent identifier,
            usually from nc filename or internal variable value.
        inseason = integer; taken from SEASONS_LU dictionary
        invar = string; the nc variable being analyzed

    returns: a string to be used as an output file naming prefix
    """
